        ...
        <motion.div className="mb-4 grid grid-cols-1 lg:grid-cols-2 gap-4">
          <div className="w-full">
            <motion.input
              ...
              className="w-full appearance-none rounded-lg border border-purple-700 bg-neutral-900 bg-opacity-90 px-3 py-2 text-md text-stone-200 shadow-sm focus:border-purple-400 focus:outline-none"
              whileInView={{ opacity: 1, y: 0 }}
              initial={{ opacity: 0, y: -100 }}
