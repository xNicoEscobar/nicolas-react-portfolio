    ...
    <div className="md:pb-20 lg:pb-20 p-4 lg:w-2/4 py-20 mx-auto" id="contact">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="flex justify-center lg:justify-end">
          <motion.button
            type="submit"
            className={`rounded-lg bg-purple-900 px-6 py-2 text-sm font-semibold text-white shadow-md hover:bg-purple-900 focus:outline-none focus:ring-2 focus:ring-stone-400 ${
